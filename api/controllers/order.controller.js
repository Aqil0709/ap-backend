...
const generateInvoicePdf = (doc, order) => {
    ...
    doc.fontSize(9).font('Helvetica-Bold').text('Appa General Store', pageMargin, topSectionY, { width: halfWidth });
    ...
    doc.font('Helvetica-Bold').text('for Appa General Store', rightColX, y, {align: 'center', width: halfWidth});
